...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["Qt3DAnimation","Qt3DRender","Qt3DQuick","Qt3DCore","QtQuick","QtGui","QtQml","QtNetwork","QtConcurrent","QtCore","DiskArbitration","IOKit"]
    ...
    libFilePathDebug: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DQuickAnimation.framework/Qt3DQuickAnimation"
    libFilePathRelease: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DQuickAnimation.framework/Qt3DQuickAnimation"
    pluginTypes: []
    ...
    cpp.includePaths: ["/Applications/Qt/5.12.5/clang_64/lib/Qt3DQuickAnimation.framework/Headers"]
    cpp.libraryPaths: []
