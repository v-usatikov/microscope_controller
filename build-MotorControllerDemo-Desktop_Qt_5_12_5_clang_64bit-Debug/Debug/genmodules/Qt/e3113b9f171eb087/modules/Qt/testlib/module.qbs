...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["Security","Foundation","ApplicationServices","QtCore","DiskArbitration","IOKit"]
