...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["Qt3DCore","QtQuick","QtGui","QtQml","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworksRelease: ["Qt3DCore","QtQuick","QtGui","QtQml","QtNetwork","QtCore","DiskArbitration","IOKit"]
    ...
    libFilePathDebug: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DQuick.framework/Qt3DQuick"
    libFilePathRelease: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DQuick.framework/Qt3DQuick"
    pluginTypes: []
    ...
    cpp.includePaths: ["/Applications/Qt/5.12.5/clang_64/lib/Qt3DQuick.framework/Headers"]
    cpp.libraryPaths: []
