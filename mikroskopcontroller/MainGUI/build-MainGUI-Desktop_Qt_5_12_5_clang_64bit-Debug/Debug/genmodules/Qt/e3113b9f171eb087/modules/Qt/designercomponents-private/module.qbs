...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["QtDesigner","QtWidgets","QtGui","QtXml","QtCore","DiskArbitration","IOKit"]
