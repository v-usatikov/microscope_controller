...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["Qt3DRender","Qt3DInput","Qt3DLogic","Qt3DCore","QtGamepad","QtGui","QtNetwork","QtConcurrent","QtCore","DiskArbitration","IOKit"]
    ...
    libFilePathDebug: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DExtras.framework/Qt3DExtras"
    libFilePathRelease: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DExtras.framework/Qt3DExtras"
    pluginTypes: []
    ...
    cpp.includePaths: ["/Applications/Qt/5.12.5/clang_64/lib/Qt3DExtras.framework/Headers"]
    cpp.libraryPaths: []
