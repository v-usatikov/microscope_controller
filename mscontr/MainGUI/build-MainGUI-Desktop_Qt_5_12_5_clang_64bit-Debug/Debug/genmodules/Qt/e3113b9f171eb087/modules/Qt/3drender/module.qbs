...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["Qt3DCore","QtGui","QtNetwork","QtCore","DiskArbitration","IOKit"]
