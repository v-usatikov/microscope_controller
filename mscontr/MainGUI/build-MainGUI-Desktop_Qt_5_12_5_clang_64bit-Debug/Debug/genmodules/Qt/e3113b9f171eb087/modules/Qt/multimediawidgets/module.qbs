...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["QtMultimedia","QtWidgets","QtGui","QtNetwork","QtCore","DiskArbitration","IOKit"]
    ...
    libFilePathDebug: "/Applications/Qt/5.12.5/clang_64/lib/QtMultimediaWidgets.framework/QtMultimediaWidgets"
    libFilePathRelease: "/Applications/Qt/5.12.5/clang_64/lib/QtMultimediaWidgets.framework/QtMultimediaWidgets"
    pluginTypes: []
    ...
    cpp.includePaths: ["/Applications/Qt/5.12.5/clang_64/lib/QtMultimediaWidgets.framework/Headers"]
    cpp.libraryPaths: []
