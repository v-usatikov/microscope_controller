...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["Qt3DRender","Qt3DCore","QtGui","QtNetwork","QtConcurrent","QtCore","DiskArbitration","IOKit"]
    ...
    libFilePathDebug: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DAnimation.framework/Qt3DAnimation"
    libFilePathRelease: "/Applications/Qt/5.12.5/clang_64/lib/Qt3DAnimation.framework/Qt3DAnimation"
    pluginTypes: []
    ...
    cpp.includePaths: ["/Applications/Qt/5.12.5/clang_64/lib/Qt3DAnimation.framework/Headers"]
    cpp.libraryPaths: []
