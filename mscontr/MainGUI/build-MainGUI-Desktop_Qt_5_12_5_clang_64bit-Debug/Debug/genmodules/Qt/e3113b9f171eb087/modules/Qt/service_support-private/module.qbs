...
QtModule {
    ...
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: ["QtGui","QtDBus","QtCore","DiskArbitration","IOKit","OpenGL","AGL"]
